...
public class Achizitie extends Tranzactie {
    ...
    public Achizitie(Map<ProdusAlimentar, Integer> listaProduseCantitate,Map<Retail, Integer> listaRetailCantitate, double pretTotal, LocalDate dataTranzactie, String cashCard) {
